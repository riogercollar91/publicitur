		...
		<div class="container" >
			...
			<div class="row ">
				...
				<?php } ?>
					...
					<li class="linkedin" data-toggle="tooltip" data-placement="bottom" title="Linkedin"><a href="<?php echo esc_url($wl_theme_options['linkedin_link']); ?>" target="_blank"><i class="fa fa-linkedin"></i></a></li>
					<?php } if($wl_theme_options['linkedin_link']!='') { ?>					
					<li class="youtube" data-toggle="tooltip" data-placement="bottom" title="Pinterest"><a href="<?php echo esc_url($wl_theme_options['pinterest_link']); ?>" target="_blank"><i class="fa fa-pinterest"></i></a></li>	
					...
					<li class="twitter" data-toggle="tooltip" data-placement="bottom" title="Google Plus"><a href="<?php echo esc_url($wl_theme_options['gplus']) ; ?>" target="_blank"><i class="fa fa-google-plus"></i></a></li>
	                <?php } if($wl_theme_options['instagram']!='') { ?>
					<li class="facebook" data-toggle="tooltip" data-placement="bottom" title="Instagram"><a href="<?php echo esc_url($wl_theme_options['instagram']) ; ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
	                <?php } ?>
					</ul>	
				</div>
