	...
	function weblizar_default_settings()
{
	...
	$ImageUrl10 = WL_TEMPLATE_DIR_URI ."/images/4.jpg";
	$wl_theme_options=array(
			...
			'slide_btn_link_3' => '#',
			'slide_image_4' => $ImageUrl10,
			'slide_title_4' => __('Slide Title 4 ', 'weblizar' ),
			'slide_desc_4' => __('Aldus PageMaker including versions of Lorem Ipsum, rutrum turpi', 'weblizar' ),
			'slide_btn_text_4' => __('Read More', 'weblizar' ),
			'slide_btn_link_4' => '#',				
			// Footer Call-Out
			'fc_home'=>'1',			
			...
			'service_1_title'=>__("Afiches",'weblizar' ),
			...
			'service_1_link'=>"http://www.publicitur.com/afiches/",
			
			'service_2_title'=>__('Campañas', 'weblizar' ),
			...
			'service_2_link'=>"http://www.publicitur.com/campanas/",
			
			'service_3_title'=>__("Catálogos", 'weblizar' ),
			'service_3_icons'=>"fa fa-book",
			...
			'service_3_link'=>"http://www.publicitur.com/catalogos/",
			
			'service_4_title'=>__("Eventos", 'weblizar' ),
			'service_4_icons'=>"fa fa-file-picture",
			...
			'service_4_link'=>"http://www.publicitur.com/eventos/",			
			
			'service_5_title'=>__("Fotografía", 'weblizar' ),
			'service_5_icons'=>"fa fa-camera",
			'service_5_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_5_link'=>"http://www.publicitur.com/fotografia/",
			
			'service_6_title'=>__("Hipermedias", 'weblizar' ),
			'service_6_icons'=>"fa fa-video",
			'service_6_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_6_link'=>"http://www.publicitur.com/hipermedias/",
			
			'service_7_title'=>__("Internet", 'weblizar' ),
			'service_7_icons'=>"fa fa-file-pdf",
			'service_7_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_7_link'=>"http://www.publicitur.com/internet/",	
			
			'service_8_title'=>__("Plegables", 'weblizar' ),
			'service_8_icons'=>"fa fa-post",
			'service_8_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_8_link'=>"http://www.publicitur.com/plegables/",	
			
			'service_9_title'=>__("Senalética", 'weblizar' ),
			'service_9_icons'=>"fa fa-car",
			'service_9_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_9_link'=>"http://www.publicitur.com/senaletica/",
			
			'service_10_title'=>__("Soporte Digitales", 'weblizar' ),
			'service_10_icons'=>"fa fa-man",
			'service_10_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_10_link'=>"http://www.publicitur.com/soportes-digitales/",
			
			'service_11_title'=>__("Video", 'weblizar' ),
			'service_11_icons'=>"fa fa-video",
			'service_11_text'=>__("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in.", 'weblizar' ),
			'service_11_link'=>"http://www.publicitur.com/videos/",							
