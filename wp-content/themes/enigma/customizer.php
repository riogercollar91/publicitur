...
function weblizar_gl_customizer( $wp_customize ) {
	...
	$ImageUrl1 = WL_TEMPLATE_DIR_URI ."/images/1.jpg";
...
$wp_customize->add_section(
	...
	'enigma_options[service_3_icons]',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_7_icons]',
                array(
                'default'=>esc_attr($wl_theme_options['service_7_icons']),
                'type'=>'option',
                'capability'=>'edit_theme_options',
                'sanitize_callback'=>'enigma_sanitize_text',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_8_icons]',
                array(
                'default'=>esc_attr($wl_theme_options['service_8_icons']),
                'type'=>'option',
                'capability'=>'edit_theme_options',
                'sanitize_callback'=>'enigma_sanitize_text',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_9_icons]',
                array(
                'default'=>esc_attr($wl_theme_options['service_9_icons']),
                'type'=>'option',
                'capability'=>'edit_theme_options',
                'sanitize_callback'=>'enigma_sanitize_text',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_10_icons]',
                array(
                'default'=>esc_attr($wl_theme_options['service_10_icons']),
                'type'=>'option',
                'capability'=>'edit_theme_options',
                'sanitize_callback'=>'enigma_sanitize_text',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_11_icons]',
                array(
                'default'=>esc_attr($wl_theme_options['service_11_icons']),
                'type'=>'option',
                'capability'=>'edit_theme_options',
                'sanitize_callback'=>'enigma_sanitize_text',
	...
	'enigma_options[service_3_title]',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_7_title]',
                array(
                'default'=>esc_attr($wl_theme_options['service_7_title']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
        ...
        $wp_customize->add_setting(
        'enigma_options[service_8_title]',
                array(
                'default'=>esc_attr($wl_theme_options['service_8_title']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
       ...
       $wp_customize->add_setting(
        'enigma_options[service_9_title]',
                array(
                'default'=>esc_attr($wl_theme_options['service_9_title']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
       ...
       $wp_customize->add_setting(
        'enigma_options[service_10_title]',
                array(
                'default'=>esc_attr($wl_theme_options['service_10_title']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
        ...
        $wp_customize->add_setting(
        'enigma_options[service_11_title]',
                array(
                'default'=>esc_attr($wl_theme_options['service_11_title']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
	...
	'enigma_options[service_3_text]',
        ...
        $wp_customize->add_setting(
        'enigma_options[service_7_text]',
                array(
                'default'=>esc_attr($wl_theme_options['service_7_text']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
        ...
        $wp_customize->add_setting(
        'enigma_options[service_8_text]',
                array(
                'default'=>esc_attr($wl_theme_options['service_8_text']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
        ...
        $wp_customize->add_setting(
        'enigma_options[service_9_text]',
                array(
                'default'=>esc_attr($wl_theme_options['service_9_text']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
        ...
        $wp_customize->add_setting(
        'enigma_options[service_10_text]',
                array(
                'default'=>esc_attr($wl_theme_options['service_10_text']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
        ...
        $wp_customize->add_setting(
        'enigma_options[service_11_text]',
                array(
                'default'=>esc_attr($wl_theme_options['service_11_text']),
                'type'=>'option',
                'sanitize_callback'=>'enigma_sanitize_text',
                'capability'=>'edit_theme_options',
                )
...
/* Social options */
	...
	$wp_customize->add_setting(
	'enigma_options[pinterest_link]',
		array(
		'default'=>esc_attr($wl_theme_options['pinterest_link']),
		'type'=>'option',
		'sanitize_callback'=>'esc_url_raw',
		'capability'=>'edit_theme_options'
		)
		...
		'label'        => __( 'Pinterest', 'social_media_incredible' ),
		'type'=>'url',
		'section'    => 'social_section',
		'settings'   => 'enigma_options[pinterest_link]'
	) );	
	$wp_customize->add_setting(
